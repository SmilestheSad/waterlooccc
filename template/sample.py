...
#from statistics import mean,median,median_high,median_high,mode
...
inputVar3 = vInput[2]   # ['3','5','7','8']
inputList1 = [int(x) for x in inputVar3.split()] # convert script to list and int [3,5,7,8]
inputList2 = vInput[2:] # ['3 5 7 8','6 9 34 1']
